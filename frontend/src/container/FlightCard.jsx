...
const FlightCard = ({ img, stops, name, time, duration, stop, trip, price, hnl}) => {
  return (
    <>
     <div className="w-full flex flex-row items-start justify-between gap-7 p-4 ">
         <div className="flex items-start gap-2">
          ...
          <div className="flex flex-col items-start justify-start">
            <h2 className="text-[#27273F] font-normal text-xs  md:text-base">{stops}</h2>
         ...
         <div className="flex flex-col items-start justify-start">
          ...
          <p className="text-[#7C8DB0] font-normal text-xs  md:text-base">{duration}</p>
         </div>
