        ...
        <div className="lg:w-[872px] w-full flex flex-col gap-10">
          <div className="flex w-full h-12 lg:flex-row items-center flex-col lg:shadowCard  relative ">
            ...
            <div className="w-full lg:w-[96px] ">
              <button
                type="button"
                onClick={() => navigate(`/explore?from=${encodeURIComponent(from)}&to=${encodeURIComponent(to)}`)}
                className="w-full bg-[#605DEC] text-[#FAFAFA] text-lg leading-6 h-[48px] px-5   rounded-b-[4px] lg:rounded-r-[4px]"
              >
                Search
              </button>
            </div>
